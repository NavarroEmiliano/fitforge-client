...
const SignUpForm = () => {
  ...
  return (
    <div className='w-full min-h-screen bg-fitforge-black flex flex-col justify-center items-center p-10 text-white'>
      ...
      <form onSubmit={onSubmit} className='max-w-[260px]'>
        <div>
